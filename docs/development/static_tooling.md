...
python3.12 -I docs/design/semantic_ingestion/traceability_golden_vectors/check_ctv_binding_authority_v2.py \
  ...
  --expected-design-sha256 6fbb7f2b59c0ba4f29534d88539905cd730870326a2d9757441fcf1483e7eb70 \
  --expected-registry-sha256 70143b278e0fd72886362f4174c726c9ecf877b1e288d3dd2c196a78f385413e \
  --expected-authority-sha256 9c9368bf008997288574afe45ff91eb8a45933fa379418c418b826223f501f79 \
...
`6fbb7f2b59c0ba4f29534d88539905cd730870326a2d9757441fcf1483e7eb70`,
authority SHA-256
`9c9368bf008997288574afe45ff91eb8a45933fa379418c418b826223f501f79`,
validator SHA-256
...
python3.12 -I docs/design/semantic_ingestion/traceability_golden_vectors/check_lifecycle_root_signer_provenance_v1.py \
  ...
  --expected-checker-sha256 afe53c9d296472d647fc194d343a0d6254193c8aaced1a99dc795068d6fe6d87 \
  --self-test
```
...
and checker SHA-256
`afe53c9d296472d647fc194d343a0d6254193c8aaced1a99dc795068d6fe6d87`.
...
exact node IDs to six shards, allowing long modules to be balanced without
changing test ownership. Collection is recomputed on every run, so newly added
tests enter a shard even before timing data is refreshed. The verifier
...
python3.12 -I docs/design/semantic_ingestion/traceability_golden_vectors/check_cgs_structural_contract_v1.py \
  ...
  --expected-checker-sha256 61aa594f0c4bbdd255a767d2d5a19ebb8cd6f0bb41ab2fde6ca1d245ba805c1c \
  --self-test
```
...
`995e625f28cde568b2b9f71e0153af4872f13182d6a4a55919839bde9bbc8976`,
and CGS checker SHA-256
`61aa594f0c4bbdd255a767d2d5a19ebb8cd6f0bb41ab2fde6ca1d245ba805c1c`.
