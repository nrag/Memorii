...
def _parent() -> None:
    ...
    result = {
        "schema": "memorii.semantic-ingestion.production-performance.default-on-wall-clock.v2",
    ...
    evidence = DEBUG_WORK / "evidence/pbd-exp-014-default-on-wall-clock-v2.json"
