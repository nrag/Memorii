...
The current provenance projection proposal awaits the owner's policy-context
choice and revised feasibility review; it is not canonical implementation authority.
