...
MANIFEST = Path(__file__).with_name("candidate-manifest-v11.json")
...
def main() -> None:
    ...
    print(json.dumps({"schema":"memorii.design-candidate-validation.v11","passed":not failures,"candidate_lock":args.expected_candidate_lock,"tracked_artifact_count":len(tracked),"failures":failures},sort_keys=True))
