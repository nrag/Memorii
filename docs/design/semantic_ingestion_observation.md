...
| Cursor, cohort and retained snapshot | `GraphObservationCursorPayload.v1`, `IngestionTimeAttestationCursorPayload.v1`, `GraphObservationCohortPreimage.v1`, `GraphRecordObservationSnapshot.v1`, `IngestionTimeObservationSnapshot.v1`, `GraphObservationRequestCoordinates.v1`, `IngestionTimeAttestationRequestCoordinates.v1`, `GraphObservationRecordKey.v1` |
...
## Ingestion-Time Cursor And Bounded Continuation Retention

The following profile-3 amendment is normative. It defines endpoint-specific
continuation and one shared bounded retention owner. Existing graph cursor
wire bytes and historical profile-2 behavior remain unchanged.
...
## Retained Provenance And Claim Policy Context

Owner decision approved on 2026-09-08: expose complete retained policy context.
The reviewed read-only recipe follows; public runtime integration remains a
