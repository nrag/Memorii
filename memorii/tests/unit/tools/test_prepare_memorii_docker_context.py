            ...
            [
                ...
                "\n".join(
                    (
                        ...
                        "from memorii.integrations.hermes_local_authority import authorize_local_level2",
                        "OpenAIResponsesApiClient.complete = lambda _client, **_kwargs: ('{\"abstained\":false,\"candidates\":[{\"predicate_id\":\"project_owner\",\"assertion_quote\":\"Mars Venus 001 project owner is Ada.\",\"subject_quote\":\"Mars Venus 001\",\"predicate_anchor_quote\":\"owner\",\"value_quote\":\"Ada\"}]}')",
                        ...
                        "messages = [{'role':'user','content':'Mars Venus 001 project owner is Ada.','timestamp':'2026-09-24T00:00:00Z'}, {'role':'assistant','content':'','tool_calls':[{'id':'tool-call:1','call_id':'provider-call:1','response_item_id':'response-item:1','type':'function','function':{'name':'lookup','arguments':'{ \\\"subject\\\": \\\"Mars Venus 001\\\", \\\"limit\\\": 1 }'}}],'reasoning':'private','timestamp':'2026-09-24T00:00:01Z'}, {'role':'tool','content':'Atlas found','tool_call_id':'tool-call:1','name':'lookup','tool_name':'lookup','timestamp':'2026-09-24T00:00:02Z','effect_disposition':'read_only'}, {'role':'assistant','content':'I will remember that.','finish_reason':'stop','timestamp':'2026-09-24T00:00:03Z'}]",
