...
def test_runtime_factory_auto_uses_rule_without_llm_config(monkeypatch) -> None:
    ...
    assert isinstance(build_promotion_decision_provider_from_env(), RuleBasedPromotionDecisionProvider)
...
def test_runtime_factory_auto_uses_hybrid_with_llm_config(monkeypatch) -> None:
    ...
    assert isinstance(build_promotion_decision_provider_from_env(), HybridPromotionDecisionProvider)
