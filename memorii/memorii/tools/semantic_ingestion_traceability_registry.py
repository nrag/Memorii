...
def _validate_references(source: dict[str, Any]) -> None:
    ...
    if len(paths) != 150 or any(not item["requirements"] for item in headings):
        raise RegistryValidationError("registry must contain exactly 150 nonempty heading defaults")
