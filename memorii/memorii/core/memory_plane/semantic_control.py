...
_SOURCE_CLASSES: dict[str, SemanticControlClass] = {
    ...
    "semantic_ingestion_capability_status": "admission",
    "semantic_ingestion_capability_initial_freshness": "admission",
    "semantic_ingestion_capability_authorization_checkpoint": "admission",
    "semantic_ingestion_capability_monitor_decision": "admission",
    ...
    "semantic_ingestion_prepared_source": "operation",
    "semantic_ingestion_bootstrap_handoff_marker": "operation",
    "semantic_ingestion_bootstrap_authority_unavailable": "operation",
    "semantic_ingestion_bootstrap_v3_recovery_index": "recovery",
    "semantic_ingestion_source_normalization_recovery_index": "recovery",
    ...
    "semantic_ingestion_bootstrap_graph_v3_member": "operation",
    "semantic_ingestion_bootstrap_graph_v3_manifest": "operation",
    "semantic_ingestion_bootstrap_graph_v3_idempotency": "operation",
    "semantic_ingestion_bootstrap_graph_v3_epoch": "operation",
    "semantic_ingestion_bootstrap_graph_v3_epoch_head": "operation",
    "semantic_ingestion_bootstrap_graph_v3_epoch_transition": "operation",
    "semantic_ingestion_bootstrap_graph_v3_terminal_locator": "operation",
    "semantic_ingestion_bootstrap_graph_v3_terminal_control": "operation",
    "semantic_ingestion_bootstrap_graph_v3_terminal_identity": "operation",
...
_ID_PREFIX_CLASSES: tuple[tuple[str, SemanticControlClass], ...] = (
    ...
    ("semantic_ingestion:capability-status:", "admission"),
    ("semantic_ingestion:capability-initial-freshness:", "admission"),
    ("semantic_ingestion:capability-authorization-checkpoint:", "admission"),
    ("semantic_ingestion:capability-monitor-decision:", "admission"),
    ...
    ("semantic_ingestion:prepared_source:", "operation"),
    ("semantic_ingestion:bootstrap-handoff:", "operation"),
    ("semantic_ingestion:bootstrap-authority-unavailable:", "operation"),
    ("semantic_ingestion:bootstrap-v3-recovery:", "recovery"),
    ("semantic_ingestion:bootstrap-graph-v3:", "operation"),
    ("semantic_ingestion:source-normalization-recovery:", "recovery"),
