...
class CheckpointDiagnosticsPayload(CheckpointDiagnosticsSection):
    ...
    def from_sections(
        ...
        return cls(
            ...
            extra_selected_ids=checkpoint.extra_selected_ids,
            allowed_definition_selected_ids=checkpoint.allowed_definition_selected_ids,
            allowed_context_selected_ids=checkpoint.allowed_context_selected_ids,
            forbidden_selected_ids=checkpoint.forbidden_selected_ids,
            answer_match_type=checkpoint.answer_match_type,
            failure_classification=checkpoint.failure_classification,
            selected_excluded_ids=checkpoint.selected_excluded_ids,
            supporting_excluded_ids=checkpoint.supporting_excluded_ids,
            rejected_expected_ids=checkpoint.rejected_expected_ids,
            missing_rejected_ids=checkpoint.missing_rejected_ids,
            missing_rejected_claim_subject_entity_ids=checkpoint.missing_rejected_claim_subject_entity_ids,
            supporting_wrong_entity_claim_ids=checkpoint.supporting_wrong_entity_claim_ids,
            supporting_wrong_subject_claim_ids=checkpoint.supporting_wrong_subject_claim_ids,
            supporting_wrong_subject_entity_ids=checkpoint.supporting_wrong_subject_entity_ids,
            supporting_disambiguation_claim_ids=checkpoint.supporting_disambiguation_claim_ids,
            missing_wrong_entity_rejection_claim_ids=checkpoint.missing_wrong_entity_rejection_claim_ids,
            missing_wrong_entity_rejection_subject_ids=checkpoint.missing_wrong_entity_rejection_subject_ids,
            selected_noncurrent_claim_ids=checkpoint.selected_noncurrent_claim_ids,
            required_definition_claim_ids=checkpoint.required_definition_claim_ids,
            missing_definition_claim_ids=checkpoint.missing_definition_claim_ids,
            missing_definition_support_claim_ids=checkpoint.missing_definition_support_claim_ids,
            rejected_required_definition_claim_ids=checkpoint.rejected_required_definition_claim_ids,
            selected_entity_role_mismatches=checkpoint.selected_entity_role_mismatches,
            missing_selected_subject_entity_ids=checkpoint.missing_selected_subject_entity_ids,
            selected_object_entity_instead_of_subject_ids=checkpoint.selected_object_entity_instead_of_subject_ids,
            selected_graph_entity_overbreadth=checkpoint.selected_graph_entity_overbreadth,
            selected_nonrequired_graph_entity_ids=checkpoint.selected_nonrequired_graph_entity_ids,
            selected_context_only_entity_ids=checkpoint.selected_context_only_entity_ids,
            selected_rejected_or_context_entity_ids=checkpoint.selected_rejected_or_context_entity_ids,
            supporting_noisy_citation_event_ids=checkpoint.supporting_noisy_citation_event_ids,
            selected_claim_support_closure_errors=checkpoint.selected_claim_support_closure_errors,
            selected_claim_ids_missing_support=checkpoint.selected_claim_ids_missing_support,
            selected_claim_evidence_event_ids_missing_support=checkpoint.selected_claim_evidence_event_ids_missing_support,
            selected_action_state_event_ids_missing_support=checkpoint.selected_action_state_event_ids_missing_support,
            context_only_noise_event_ids=checkpoint.context_only_noise_event_ids,
            supporting_role_violations=checkpoint.supporting_role_violations,
            supporting_rejection_provenance_overlap=checkpoint.supporting_rejection_provenance_overlap,
            channel_overlap=checkpoint.channel_overlap,
