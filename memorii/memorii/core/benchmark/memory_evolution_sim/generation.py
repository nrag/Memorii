...
def _execution_contract() -> SimCheckpointContract:
    return SimCheckpointContract(
        ...
        observations.extend(
            [
                SurfaceObservation(
                    ...
                    timestamp=branch_a_started_time,
                    source_type="user",
                    modality="assertion",
                    phase="setup",
                    trust_level=3,
                ...
                SurfaceObservation(
                    ...
                    timestamp=branch_a_blocked_time,
                    source_type="user",
                    modality="assertion",
                    phase="interference",
                    trust_level=3,
                ...
                SurfaceObservation(
                    ...
                    timestamp=branch_b_started_time,
                    source_type="user",
                    modality="assertion",
                    phase="evolution",
                    trust_level=3,
                ...
                SurfaceObservation(
                    ...
                    timestamp=branch_b_progress_time,
                    source_type="user",
                    modality="assertion",
                    phase="evolution",
                    trust_level=3,
